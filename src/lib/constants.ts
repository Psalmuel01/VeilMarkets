export const PROGRAM_ID = "veilmarkets_core_v10.aleo";
export const CREDITS_TOKEN_PROGRAM_ID = "veilmarkets_token_credits_v10.aleo";
export const USDCX_TOKEN_PROGRAM_ID = "veilmarkets_token_usdcx_v10.aleo";
export const USAD_TOKEN_PROGRAM_ID = "veilmarkets_token_usad_v10.aleo";
export const ORACLE_PROGRAM_ID = "veilmarkets_oracle_v10.aleo";
export const FACTORY_PROGRAM_ID = "veilmarkets_factory_v10.aleo";
export const GOVERNANCE_PROGRAM_ID = "veilmarkets_governance_v10.aleo";
