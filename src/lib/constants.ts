export const PROGRAM_ID = "veilmarkets_core_build_v11.aleo";
export const CREDITS_TOKEN_PROGRAM_ID = "veilmarkets_credits_build_v11.aleo";
export const USDCX_TOKEN_PROGRAM_ID = "veilmarkets_usdcx_build_v11.aleo";
export const USAD_TOKEN_PROGRAM_ID = "veilmarkets_usad_build_v11.aleo";
export const ORACLE_PROGRAM_ID = "veilmarkets_oracle_build_v11.aleo";
export const FACTORY_PROGRAM_ID = "veilmarkets_factory_build_v11.aleo";
export const GOVERNANCE_PROGRAM_ID = "veilmarkets_gov_build_v11.aleo";
