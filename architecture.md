...
## 1) Factory (`veilmarkets_factory_v12.aleo`)
...
## 2) Core (`veilmarkets_core_v12.aleo`)
...
## 3) Oracle (`veilmarkets_oracle_v12.aleo`)
...
## 4) Governance (`veilmarkets_governance_v12.aleo`)
