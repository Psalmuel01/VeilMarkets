...
## 1) Factory (`veilmarkets_factory_v13.aleo`)
...
## 2) Core (`veilmarkets_core_v13.aleo`)
...
## 3) Oracle (`veilmarkets_oracle_v13.aleo`)
...
## 4) Governance (`veilmarkets_governance_v13.aleo`)
