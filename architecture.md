...
## 1) Factory (`veilmarkets_factory_v15.aleo`)
...
## 2) Core (`veilmarkets_core_v15.aleo`)
...
## 3) Oracle (`veilmarkets_oracle_v15.aleo`)
...
## 4) Governance (`veilmarkets_governance_v15.aleo`)
